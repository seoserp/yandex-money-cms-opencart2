...
>
> Модуль копирует файлы шаблонов в каталог с темой default (`catalog/view/theme/default`) вашего сайта и у вас используется другой каталог с шаблоном, то скопируйте файлы модуля из архива (`\catalog\view\theme`) в каталог с Вашей темой
